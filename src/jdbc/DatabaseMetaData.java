...
public class DatabaseMetaData implements java.sql.DatabaseMetaData{
	...
	public DatabaseMetaData(Connection parent_){
		parent = parent_;
	}
	...
	public ResultSet getTables(String arg0, String arg1, String arg2,
		...
		ResultSetMetaData meta = new ResultSetMetaData(parent.getTablesMeta(), new String[]{"TABLE_NAME"});
		
		TableMeta[] tmp = parent.getTablesMeta();
		String[][] data = new String[tmp.length][1];
		
		for(int i=0; i<tmp.length; i++)
			data[i][0] = tmp[i].tableName();
		
		ResultSet results = new ResultSet(meta, data, null);
	...
	@Override
	public java.sql.ResultSet getPseudoColumns(String arg0, String arg1,
